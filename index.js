...
console.log(getArtistByIndex(artists, 0))//this is a test
 /**
...
let array20 = array.filter(
  (arr1) => arr1.years.slice(0,5) > 1900
)

let arr2 = [];
for(let i =0; i < array20.length; i++){
arr2.push(array20[i].name)
}
return arr2;
...
let samiArray =
   {
    ...
    "genre": "Northern Renaissance",
    "nationality": "USA",
    "bio": "My name is Sami AlAloosi and I am a full-stack Web Application Developer and Software Developer, currently living in Seattle, WA. I am both driven and self-motivated, and I am constantly experimenting with new technologies and techniques.",
    "paintings": 0
  }


function addArtist(array,addArray){
array.push(addArray);
return array;
 }

console.log(addArtist(artists, samiArray))
